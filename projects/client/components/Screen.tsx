...
const KeyboardAwareScrollable = ({
  ...
  const commonProps: Record<string, any> = {
    ...
    keyboardShouldPersistTaps: (childAttrs['keyboardShouldPersistTaps'] as string | undefined) ?? 'handled',
    keyboardDismissMode: (childAttrs['keyboardDismissMode'] as string | undefined) ?? 'on-drag',
    ...
    ...(Platform.OS === 'ios'
      ? { contentInsetAdjustmentBehavior: (childAttrs['contentInsetAdjustmentBehavior'] as string | undefined) ?? contentInsetBehaviorIOS }
      : {}),
  };
